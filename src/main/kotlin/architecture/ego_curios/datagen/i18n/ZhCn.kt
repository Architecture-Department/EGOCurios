...
class ZhCn(output: PackOutput) : DatagenI18n(output, EgoCuriosUtil.ID, "zh_cn") {
	...
	override fun addTranslations() {
		...
		//region tag标签
		add(EgoCuriosItemTags.EGO_CURIOS, "E.G.O.饰品")
		add(EgoCuriosItemTags.EGO_CURIOS_HEADWEAR, "E.G.O.饰品-头饰")
		add(EgoCuriosItemTags.EGO_CURIOS_HEAD, "E.G.O.饰品-头部")
		add(EgoCuriosItemTags.EGO_CURIOS_HINDBRAIN, "E.G.O.饰品-后脑")
		add(EgoCuriosItemTags.EGO_CURIOS_EYE, "E.G.O.饰品-眼部")
		add(EgoCuriosItemTags.EGO_CURIOS_FACE, "E.G.O.饰品-面部")
		add(EgoCuriosItemTags.EGO_CURIOS_CHEEK, "E.G.O.饰品-脸颊")
		add(EgoCuriosItemTags.EGO_CURIOS_MASK, "E.G.O.饰品-口罩")
		add(EgoCuriosItemTags.EGO_CURIOS_MOUTH, "E.G.O.饰品-口部")
		add(EgoCuriosItemTags.EGO_CURIOS_NECK, "E.G.O.饰品-颈部")
		add(EgoCuriosItemTags.EGO_CURIOS_BROOCH, "E.G.O.饰品-胸针")
		add(EgoCuriosItemTags.EGO_CURIOS_HAND, "E.G.O.饰品-手部")
		add(EgoCuriosItemTags.EGO_CURIOS_GLOVE, "E.G.O.饰品-手套")
		add(EgoCuriosItemTags.EGO_CURIOS_BACK, "E.G.O.饰品-背后")
		//endregion
	}
}
